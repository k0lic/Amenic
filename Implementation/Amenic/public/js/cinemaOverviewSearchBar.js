...
function employeeTemplate(employee) {
    ...
    "<div><h1>"+employee.firstName+" "+employee.lastName+"</h1></div>"+
    "<div><span>"+employee.email+"</span></div>"+
    "</div>"+
    "<div class=\"binWrapper\">"+
    "<button type=\"button\""+
    "onClick=\"document.getElementById('workerForDelete').value='"+employee.email+"'; areYouSure('You are about to remove an employee.','/Cinema/ActionRemoveEmployee')\""+
