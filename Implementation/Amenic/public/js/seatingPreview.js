function updateSeatingPreview() {
    ...
    if (seats == 0 || rows>26 || columns>26) {
        ...
        if (seats == 0) {
            target.innerHTML = "<div class=\"centerItalic\">There are no seats in this room yet!</div>";
        } else {
            target.innerHTML = "<div class=\"centerItalic\">There are too many seats in this room!</div>";
        }
        
    } else {
        target.style.gridTemplateColumns = "repeat(" + (Number(columns) + 1) + ", 1fr)";
